...
if (class_exists('Memcache'))
{
  ...
  $min_cachePath = new Minify_Cache_Memcache($memcache, 3600);
}
 ...
 */
$min_serveOptions['minifiers']['text/css'] = ['Minify_CSSmin', 'minify'];
 ...
 */
$min_serveOptions['minifiers']['application/x-javascript'] = ['Minify_JS_ClosureCompiler', 'minify'];
