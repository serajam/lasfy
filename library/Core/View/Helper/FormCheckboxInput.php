 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Core_View_Helper_FormCheckboxInput extends Zend_View_Helper_FormElement
{
    /**
     * Input type to use
     *
     ...
     */
    public function formCheckboxInput(
        $name,
        $value = null,
        $attribs = null,
        $options = null,
    ...
    )
    {
        ...
        foreach ($options as $opt_value => $opt_label) {
            ...
            $radio .= '<tr><td>'
                . $opt_label
                . '</td><td><input type="' . $this->_inputType . '"'
                . ' name="' . $name . '"'
                . ' id="' . $optId . '"'
            ...
            $radio .= '<td class="sub-element">'
                . '<input type="text"'
                . ' name="' . str_replace('[]', '', $baseName) . '[' . $opt_value . ']"'
                . ' id="' . $opt_value . '-sub"'
                . $checked
                . $disabled
        ...
        $xhtml = '<table cellspacing=5 id="' . $id . '">';
        // done!
        $xhtml .= $radio;
        $xhtml .= '</table>';
