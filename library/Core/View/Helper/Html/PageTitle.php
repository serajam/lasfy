 ...
 */
class Core_View_Helper_Html_PageTitle extends Core_View_Helper_View
{
    /**
    ...
    public function pageTitle($append = false, $titleOther = false)
    {
        ...
        return '<div class="title"><h1>' . ($titleOther ? $titleOther : $title) . '</h1><hr></div>';
    }
    ...
    protected function _getTitle()
    {
        ...
        foreach ($acl as $a) {
            if ($a['resourceCode'] == $curSys && $a['action'] == $curAct) {
