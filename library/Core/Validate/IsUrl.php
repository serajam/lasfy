 ...
 * @author Ron Dobley
 */
class Core_Validate_IsUrl extends Zend_Validate_Abstract
{
    /**
     * Error codes
     *
    ...
    public function isValid($value)
    {
        ...
        $hostnameValidator
            = new Zend_Validate_Hostname(Zend_Validate_Hostname::ALLOW_DNS); //do not allow local hostnames, this is the default
