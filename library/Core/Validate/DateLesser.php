 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Core_Validate_DateLesser extends Zend_Validate_Abstract
{
    const NOT_LESSER = 'dateInvalid';
    ...
    protected $_messageTemplates
        = [
            self::NOT_LESSER => "'%value%' not less than '%dates%'",
        ];
    ...
    public function __construct($date)
    {
        ...
        $this->_messageTemplates = [
            self::NOT_LESSER =>
                Zend_Registry::get('translation')->get('date_less_than')
        ];
    }
